return {
  ...
  opts = {
    ...
    keymaps = {
      ...
      ["gC"] = { function() require("oil").open(vim.fn.expand("$HOME/src/scripts/bin")) end, desc = "Change to ~/src/scripts/bin" },
      ...
      ["gZ"] = { function() require("oil").open(vim.fn.expand("#:p:h")) end, desc = "Change to directory of file opened in original buffer" },
      ["gz"] = { desc = "Prompt for directory to change to", function()
