...
-- vim.api.nvim_create_autocmd("BufWritePre", { callback = function(args) M.format_buffer(args.buf) end, })
vim.api.nvim_create_user_command("FormatBuffer", function() M.format_buffer() end, {})
vim.keymap.set("n", "<leader>F", function() M.format_buffer() end, { silent = true, desc = "Format Buffer" })
