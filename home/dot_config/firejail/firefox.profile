...
# Use Profiles from ~/.config -- noblacklist ${HOME}/.mozilla
...
# Use Profiles from ~/.config -- mkdir ${HOME}/.mozilla
whitelist ${HOME}/.cache/mozilla/firefox
# Use Profiles from ~/.config -- whitelist ${HOME}/.mozilla

whitelist /usr/share/firefox
read-only /usr/share/firefox

whitelist /usr/share/gnome-shell/search-providers/firefox-search-provider.ini
read-only /usr/share/gnome-shell/search-providers/firefox-search-provider.ini
